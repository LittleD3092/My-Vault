...
const char NAME_HDR[][LABEL_LEN] = {"NAME"};
const int NAME_HDR_SIZE = 1;
const char ID_HDR[][LABEL_LEN] = {"StudentID"};
const int ID_HDR_SIZE = 1;
const char C[][LABEL_LEN] = {"Chinese"};
const int C_SIZE = 1;
const char M[][LABEL_LEN] = {"Math"};
const int M_SIZE = 1;
const char E[][LABEL_LEN] = {"English"};
const int E_SIZE = 1;
const char CS[][LABEL_LEN] = {"ComputerScience"};
const int CS_SIZE = 1;
