...
![](attachments/ngram-without-preprocess.png)

2. with `remove_stopwords`:

![](attachments/ngram-with-remove-stopwords.png)

3. with custom preprocess:

![](attachments/ngram-with-custom-preprocess.png)
...
![](attachments/BERT-with-remove_stopwords.png)
...
![](attachments/RNN-with-remove_stopwords.png)
